...
### Phase 2 — 多人社交 🚧 *M2.0、M2.1 代码完成；M2.2 已完整验收；M2.3-D 验收收尾中*
...
- 🚧 **M2.3-D**：Vue 群界面已提交为 `e1ec8fc`，CI #43 通过；MySQL 8.4 与三账号真实浏览器验收发现并修复跨域 `PATCH` 和退群列表竞态，本次修复等待 CI 复验，详见 [M2.3 验收记录](docs/M2.3验收记录.md)
- 📋 **M2.4**：多人跑团尚未开始
